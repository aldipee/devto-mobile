  ...
  <>
    <Placeholder>
      ...
      <View
        style={[
          Styles.containerTitle,
          {paddingTop: 10, backgroundColor: theme.SECONDARY_BACKROUND_COLOR},
        ]}>
        <PlaceholderLine
          style={{width: '100%', backgroundColor: theme.PLACEHOLDER_COLOR}}
        />
        <PlaceholderLine
          style={{width: '100%', backgroundColor: theme.PLACEHOLDER_COLOR}}
        />
      ...
      <View
        style={[
          ...
          {paddingTop: 35, backgroundColor: theme.SECONDARY_BACKROUND_COLOR},
        ]}>
        <PlaceholderLine
          style={{
            width: '60%',
  ...
  return (
    <>
      ...
      {props.loading ? (
        ...
        <>
          <Progress.Bar
            progress={currentHeight ? currentHeight / heightContent : 0}
            width={w.width}
          ...
          <Animated.ScrollView
            ...
            onLayout={(e) => console.log(e.target, 'Layout')}
            ...
            <View
              ...
              <Text style={Styles.textDate}>
                {DATA && DATA.categories && DATA.categories[0].title}{' '}
              </Text>
              <Icon
                color={theme.SECONDARY_TEXT_COLOR}
                name="ellipse"
            ...
            <View
              ...
              <Text
                style={[Styles.textTitle, {color: theme.PRIMARY_TEXT_COLOR}]}>
                {DATA && DATA.title}
              </Text>
            </View>
            ...
            <View
              style={[
                Styles.containerAuthor,
                {backgroundColor: theme.SECONDARY_BACKROUND_COLOR},
              ]}>
              <Text style={[Styles.author, {color: theme.PRIMARY_TEXT_COLOR}]}>
                {`${DATA && DATA.author && DATA.author.name}, ${
                  DATA && DATA.author && DATA.author.description
                }`}{' '}
              </Text>
            </View>
            ...
            <View
              style={[
                Styles.seperator,
                {backgroundColor: theme.SEPERATOR_COLOR},
              ]}
            />
                ...
                <ProgressiveImage
                  ...
                  thumbnailSource={{
                    uri: `${
                      DATA &&
                      DATA.attachments &&
                      DATA.attachments[0].images['post-thumbnail'].url
                    }`,
                  }}
                  source={{
                    uri: `${
                      DATA &&
                      DATA.attachments &&
                      DATA.attachments[0].images.full.url
                    }`,
                  }}
                  style={Styles.image}
                />
